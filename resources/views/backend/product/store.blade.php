        ...
        <div class="d-flex gap-10">
            <div class="col-md-10 border-right">
                <div class="ibox col-md-12">
                    <h5 class="title">{{ __('Thông tin chung') }}</h5>
                    <hr>
                    @if ($errors->any())
            ...
            <div class="col-md-2">
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="" class="col-form-label">{{ __('Danh mục sản phẩm') }}
                        ...
                        <select name="product_catalogue_id" class="form-control">
                            ...
                            @foreach($viewModel->getProductCatalogue() as $val)
                                {{$val['id']}}
                                <option
                                    {{ (old('product_catalogue_id') == $val['id'] || (isset($post) && $post->product_catalogue_id ==
                                    $val['id'])) ? 'selected' : '' }}
                ...
                <div class="form-row">
                    <label for="" class="col-form-label">{{ __('Ảnh bìa sản phẩm') }}</label> <br>
