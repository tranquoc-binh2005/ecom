<div class="navbar-custom">
                ...
                <div class="slimscroll noti-scroll">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item active">
                        <div class="notify-icon">
                            <img src="templates\admin\assets\images\users\user-1.jpg" class="img-fluid rounded-circle" alt=""> </div>
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <div class="notify-icon">
                            <img src="templates\admin\assets\images\users\user-4.jpg" class="img-fluid rounded-circle" alt=""> </div>
    ...
    <div class="logo-box">
        <a href="index.html" class="logo text-center">
                        <span class="logo-lg">
                            <img src="templates\admin\assets\images\logo-light.png" alt="" height="24">
                            <!-- <span class="logo-lg-text-light">Upvex</span> -->
                        </span>
            <span class="logo-sm">
                            <!-- <span class="logo-sm-text-dark">X</span> -->
                            <img src="templates\admin\assets\images\logo-sm.png" alt="" height="28">
                        </span>
        </a>
    </div>
    ...
    <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
        ...
        <li>
            @if (app()->getLocale() == 'vi')
                <a href="{{ url('lang/en') }}" class="flag-language waves-effect waves-light">
                    <img src="templates\admin\assets\images\flag-vn.webp"">
                </a>
            @else
                <a href="{{ url('lang/vi') }}" class="flag-language waves-effect waves-light">
                    <img src="templates\admin\assets\images\flag-en.svg"">
                </a>
            @endif
        </li>
